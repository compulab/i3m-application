...
#define BAUD_RATE_LOW_REG           USART_PORT.BAUDCTRLA
#define UART_CONTROL_REG            USART_PORT.CTRLB
#define ENABLE_TRANSMITTER_BIT      USART_TXEN_bp
#define ENABLE_RECEIVER_BIT         USART_RXEN_bp
#define UART_STATUS_REG             USART_PORT.STATUS
...
#define UART_DATA_REG               USART_PORT.DATA
